  ...
  const generatePDF = () => {
    try {
      ...
      doc.text(`Mode de paiement: ${
        ...
        formData.paymentMethod === 'card' ? 'Carte' : 'Virement'
                      ...
                      <div className="grid grid-cols-2 gap-2 text-sm text-gray-500">
                        <div>
                          ...
                          <input
                            ...
                            className="ml-2 w-16 border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
                          />
                        </div>
                        <div>
        ...
        <div className="mt-8 flex justify-end space-x-3 print-hide">
          <button
            ...
            className="px-4 py-2 text-sm font-medium text-white bg-green-600 
                     border border-green-600 rounded-md hover:bg-green-700 
